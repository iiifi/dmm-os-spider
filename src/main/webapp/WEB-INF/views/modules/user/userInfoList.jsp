...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/user/userInfo/">知乎用户列表</a></li>
		<shiro:hasPermission name="user:userInfo:edit"><li><a href="${ctx}/user/userInfo/form">知乎用户添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="userInfo">
			<tr>
				<shiro:hasPermission name="user:userInfo:edit"><td>
					...
					<a href="${ctx}/user/userInfo/delete?id=${userInfo.id}" onclick="return confirmx('确认要删除该知乎用户吗？', this.href)">删除</a>
